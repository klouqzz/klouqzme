...
function MyApp({ Component, pageProps }) {
  ...
  return <>
    ...
    {router.asPath === '/' && (
      <>
        <div style={{ zIndex: 1 }} className="hidden lg:block absolute layout-colored-background dark:opacity-20" />
        <div style={{ zIndex: 1 }} className="hidden lg:block bottom-0 rotate-[96deg] fixed layout-colored-background dark:opacity-20" />
      </>
    )}
